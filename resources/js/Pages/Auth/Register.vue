    ...
    <div class="relative flex min-h-screen w-full items-center justify-start overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-blue-600 px-32 lg:justify-start">
        ...
        >
            ...
            <div class="mb-7 text-center">
                ...
                <p class="mt-1.5 text-sm text-gray-500">Welcome! Please fill in your details.</p>
            </div>
            ...
            <form class="space-y-2" @submit.prevent="submit">
                <div>
                    ...
                    <input
                        ...
                        :class="form.errors.name ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200'"
                    />
                ...
                <div>
                    ...
                    <div class="relative">
                        <input
                            ...
                            placeholder="••••••••"
                            class="block w-full rounded-xl border bg-gray-50 py-2.5 pl-4 pr-11 text-sm text-gray-900 outline-none ring-blue-500/10 transition-all duration-200 placeholder:text-gray-400 focus:border-blue-500 focus:bg-white focus:ring-0"
                            :class="form.errors.password_confirmation ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200'"
                        />
                        <button
                            type="button"
                            tabindex="-1"
                ...
                <button
                    ...
                    class="!mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/25 transition-all duration-200 hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70"
                >
                ...
                <p class="text-center text-sm text-gray-500">
                    ...
                    <Link :href="route('login')" class="font-medium text-blue-600 transition-colors hover:text-blue-800">Sign in</Link>
                </p>
            </form>

            <div class="mt-5 flex flex-col items-center gap-1.5 border-t border-gray-100 pt-3 text-center">
