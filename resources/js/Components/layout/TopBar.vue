...
<template>
    <div class="flex h-16 items-center gap-4 px-4 sm:px-6">
        <Link :href="route('dashboard')" class="flex shrink-0 items-center gap-2">
            <div
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-sm font-bold text-white"
            >
                ERP
            </div>
            <span class="hidden text-lg font-semibold text-gray-800 sm:block">Ayodya ERP</span>
        </Link>
        ...
        <div class="mx-auto hidden max-w-md flex-1 md:block">
            <div class="relative">
                ...
                <input
                    ...
                    class="w-full rounded-xl border-0 bg-gray-100 py-2 pl-10 pr-4 text-sm text-gray-700 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-indigo-500"
                />
            </div>
        </div>
